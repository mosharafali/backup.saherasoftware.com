    ...
    px-4"
      >
        ...
        <h1 className="flex text-3xl font-bold mb-10 items-center justify-center">
          Privacy Policy of Sahera software
        </h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Sahera software.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Sahera software, accessible
              from{" "}
              <a
                href="https://saherasoftware.com/"
        ...
        <p>
          ...
          already associated with Your Third-Party Social Media Services
        ...
        <p>
          ...
          the Company through Your Third-Party Social Media Services account. If
        ...
        <div className="mb-2">
          ...
          <Link href="/contact">https://saherasoftware.com/contact</Link>
        </div>
        <Script
          data-cfasync="false"
