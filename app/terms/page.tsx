  ...
  return (
    ...
    px-4"
      >
        ...
        <p>Welcome to Sahera software!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Sahera softwares Website, located at
          <Link href="https://saherasoftware.com">
            {" "}
            https://saherasoftware.com.
          </Link>
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Sahera software if you do not agree
        ...
        <p>
          ...
          compliant to the Companys terms and conditions. The Company,
          ...
          manner for the express purpose of meeting the Clients needs in respect
          of provision of the Companys stated services, in accordance with and
        ...
        <p>
          We employ the use of cookies. By accessing Sahera software, you agreed
          to use cookies in agreement with the Sahera softwares Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Sahera software and/or its licensors own the
          intellectual property rights for all material on Sahera software. All
          intellectual property rights are reserved. You may access this from
          Sahera software for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Sahera software</li>
          <li>Sell, rent or sub-license material from Sahera software</li>
          <li>Reproduce, duplicate or copy material from Sahera software</li>
          <li>Redistribute content from Sahera software</li>
        </ul>
        ...
        <p>
          ...
          Sahera software does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Sahera software,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, Sahera
          software shall not be liable for the Comments or for any liability,
        ...
        <p>
          Sahera software reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Sahera software a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Sahera software; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Sahera software. Please include your name, your
        ...
        <p>
          No use of Sahera softwares logo or other artwork will be allowed for
